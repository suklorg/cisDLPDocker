...
lp_sod_router.get('/sodlecivepripravky', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (Object.keys(req.query).length === 0) {
            ...
            oraExecuteResult = yield (0, common_1.ExecuteProcedure)(common_1.oraProcs.getSodLecivePripravky);
        }
        //
        ...
        //
            ...
            oraExecuteResult = yield (0, common_1.ExecuteProcedure)(common_1.oraProcs.getSodLecivePripravkyKodSukl);
        }
        //
        ...
        //
            ...
            oraExecuteResult = yield (0, common_1.ExecuteProcedure)(common_1.oraProcs.getSodLecivePripravkyKody);
        }
        //
